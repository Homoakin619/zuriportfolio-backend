 ...
 *       - Project
 */
projectsRouter.post("", uploadHandler, createProject);
...
projectsRouter.put("/:project_id", uploadHandler, updateProjectById);
...
projectsRouter.get("/users/:user_id/projects", getAllProjectsForUser);
