 ...
 *                   description: null
 */
portfolioRouter.get("/portfolio/:slug", getPortfolioDetails);
 ...
 *                   type: string
 */
portfolioRouter.get("/portfolioDetails", getAllPortfolioDetails);
...
// portfolioRouter.put("/update-profile-details/:userId", validateUpdatePortfolioDetails(updatePortfolioDataSchema), updatePortfolioDetail);
 ...
 *                   type: string
 */
portfolioRouter.delete("/profile-details/:id", deletePortfolioDetails);
