 ...
 *       - Award
 */
awardRouter.post("/:userId", validateCreateAwardData, createAwardController);
 ...
 *       - Award
 */
awardRouter.put("/:awardId", updateAwardController);
 ...
 *                   type: string
 */
awardRouter.get("/:id", getAwardController);
 ...
 *       - Award
 */
awardRouter.get("/", getAllAwardsController);
 ...
 *       - Award
 */
awardRouter.delete("/:id", deleteAwardController);
 ...
 *                   type: string
 */
awardRouter.get("/:userId", getAwardByUserId)
