 ...
 *       - References
 */
referencesRouter.get("", getAllReference);
 ...
 *               error: "Invalid request"
 */
referencesRouter.get("/:userId", getAllUserReference);
 ...
 */
referencesRouter.delete("/:id", deleteReferenceDetail);
 ...
 *               error: "Invalid request"
 */
referencesRouter.put("/:id", updateReference);
