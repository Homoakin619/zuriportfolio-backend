 ...
 *               type: string
 */
degreeRouter.post("/", createDegreeController);
 ...
 *                   type: string
 */
degreeRouter.get("/:id", fetchDegree);
 ...
 *                   type: string
 */
degreeRouter.get("/", fetchAllDegree);
 ...
 *       - Degree
 */
degreeRouter.put("/:id", updateExisitingDegree);
 ...
 *                   type: string
 */
degreeRouter.delete("/:degreeId", deleteDegree);
