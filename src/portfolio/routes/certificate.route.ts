 ...
 *                   type: null
 */
certificateRouter.post("/:userId", addCertificateController);
 ...
 *                   type: string
 */
certificateRouter.get("/:userId", getAllCertificates);
 ...
 *                   type: string
 */
certificateRouter.delete("/:userId/:certId", deleteCertificate);
 ...
 *                   type: string
 */
certificateRouter.get("/:userId/:certId", getCertificateById);
 ...
 *                   type: null
 */
certificateRouter.put("/:userId/:certId", updateCertificate);
