 ...
 *                   type: null
 */
educationRouter.get("/:id", fetchUserEducationDetail);
 ...
 *                   type: null
 */
educationRouter.post("/:id", createEducationDetailController);
 ...
 *                   type: string
 */
educationRouter.get("/:id", getEducationDetailById);
 ...
 *                 type: string
 */
educationRouter.get("Detail/:id", getEducationDetailById);
 ...
 *                   type: string
 */
educationRouter.delete("/:id", deleteEducationDetail);
