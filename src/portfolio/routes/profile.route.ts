...
profileRouter.post("/cover/upload", uploadHandler, uploadProfileCoverController);
 ...
 *     in: header
 */
profileRouter.post("/image/upload", uploadHandler, uploadProfileImageController);
...
profileRouter.delete("/details/:userId", deleteAllSectionEntries);
