 ...
 *                   type: null
 */
customRouter.post("/section", validateSchema(sectionSchema), createSection);
 ...
 *                   type: null
 */
customRouter.post("/custom", validateSchema(customUserSectionSchema), create);
 ...
 *       - Custom
 */
customRouter.get("/custom", findAll);
 ...
 *                   type: null
 */
customRouter.get("/section", validateQuery(getSectionSchema), getSection);
...
customRouter.get("/custom-fields", validateQuery(getcustomfieldsSchema), findAllCustomField);
/**
 * @swagger
 * /api/v1/custom/{id}:
 *   get:
 ...
 *       - Custom
 */
customRouter.get("/custom/:id", findOne);
 ...
 *                   type: null
 */
customRouter.get("/section/:id", getSingleSection);
/**
 * @swagger
 * /api/v1/custom/field:
 *   post:
...
customRouter.post("/custom/field", validateSchema(fieldsSchema), createCustomField);
 ...
 *       - Custom Fields
 */
customRouter.get("/custom/field/:id", findOneCustomField);
 ...
 *       - Custom
 */
customRouter.delete("/custom-section/:id", deleteCustomSection);
 ...
 *                   type: null
 */
customRouter.delete("/section/:id", deleteSection);
 ...
 *                   type: null
 */
customRouter.delete("/custom/field/:id", deleteCustomFields);
 ...
 *       - Custom Fields
 */
customRouter.put("/custom/field/:id", updateCustomField);
 ...
 *                   type: null
 */
customRouter.put("/section/:id", validateSchema(updateSectionSchema), UpdateSection);
 ...
 *                   type: null
 */
customRouter.put("/custom/:id", updateCustomSection);